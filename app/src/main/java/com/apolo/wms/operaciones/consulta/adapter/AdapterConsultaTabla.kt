...
import com.apolo.wms.operaciones.consulta.ConsultarTablas
import com.apolo.wms2.R

class AdapterConsultaTabla (private val context: Context,
                            private val dataSource: List<ConsultaCampo>,
                            private val molde: Int ) : RecyclerView.Adapter<AdapterConsultaTabla.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.llback.setOnClickListener {
            ConsultarTablas.posicionConsultaTabla = position
        ...
        if (ConsultarTablas.posicionConsultaTabla == position) {
