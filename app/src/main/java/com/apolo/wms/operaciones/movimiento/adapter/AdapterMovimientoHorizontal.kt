...
class AdapterMovimientoHorizontal (private val context: Context,
                                   private val dataSource: List<MovimientoHV>,
                                   private val molde: Int ) : RecyclerView.Adapter<AdapterMovimientoHorizontal.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.llback2.setOnClickListener {
            MovimientoHorizontal.posicionOperacion = position
        ...
        holder.ibtnEliminar.setOnClickListener {
            ...
            SweetAlertDialog(context, SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener { sDialog ->
                    ...
                    if(MovimientoHorizontal.elimina_det(ItemsViewModel)){
                        CoroutineScope(Dispatchers.Main).launch {
                            try {
                                MovimientoHorizontal.obtieneListaOperaciones()
                            } catch (e: Exception){
...
//                        }
        ...
        if (MovimientoHorizontal.posicionOperacion == position) {
