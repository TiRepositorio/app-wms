...
class AdapterDetalleInventario (private val context: Context,
                                private val dataSource: List<DetalleInventario>,
                                private val molde: Int ) : RecyclerView.Adapter<AdapterDetalleInventario.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.llback.setOnClickListener {
            DetallePlanillaInventario.posicionDetalle = position
        ...
        if (DetallePlanillaInventario.posicionDetalle == position) {
